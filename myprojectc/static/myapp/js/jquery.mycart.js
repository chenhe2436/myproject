  ...
  var loadMyCartEvent = function(userOptions){
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td title="合计" class="' + classProductTotal + '">￥' + total + '</td>' +
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '</tr>'
        : '<div class="alert alert-danger" role="alert" id="' + idEmptyCartMessage + '">购物车空空如也，请前去购物～</div>'
      );
    ...
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      totalprice = $(this).parent("td").next("." + classProductTotal).text()
      $cartBadge.text(ProductManager.getTotalQuantity());
      showGrandTotal();
      showDiscountPrice();
      cart = {'id':id,"price":price,"num":quantity,"totalprice":totalprice}
